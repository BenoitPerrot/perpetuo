...
<div sticky class="table" style="background: #fff">
  ...
  <div style="display: flex;">
    <div class="product-name">
      <perpetuo-list-editor id="productFilter" key="productName" label="Filter" choices="[[productNames]]" initial-count="10" max-count="10" on-selected-item-changed="updateFilter"></perpetuo-list-editor>
    </div>
